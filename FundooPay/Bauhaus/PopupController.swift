...
open class PopupController: UIViewController {
    ...
    public enum PopupLayout {
        case top, center, bottom, mychoise, mychoise2, mychoise1
        
        func origin(_ view: UIView, size: CGSize = UIScreen.main.bounds.size) -> CGPoint {
            switch self {
            case .top: return CGPoint(x: (size.width - view.frame.width) / 2+90, y: 62)
            ...
            case.mychoise2: return CGPoint(x:34, y:313.5)
            case.mychoise1: return CGPoint(x:x_position, y:y_position)
            case.mychoise: return CGPoint(x:x_position, y:y_position+1)
...
public extension PopupController {
    ...
    public func show(_ childViewController: UIViewController) -> PopupController {
     ...
     public func change(_ childViewController: UIViewController) -> PopupController {
